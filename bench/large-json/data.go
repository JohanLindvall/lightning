...
// Benchmark is the root of the large-json benchmark: the San Francisco "citylots"
...
//
// Every nested type is an anonymous struct so that only Benchmark carries a generated
// UnmarshalJSON; that keeps the `type benchmarkStd Benchmark` baseline used by the stdlib
