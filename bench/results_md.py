...
Usage: results_md.py <src results.txt> <dst .md> [cpu-name]. run_bench.sh passes
an architecture-specific destination (results_<goarch>.md) and, as an optional
third argument, a CPU brand string detected via github.com/klauspost/cpuid (Go's
own `cpu:` line is blank — "unknown" — on arm64)."""
import re
import sys
