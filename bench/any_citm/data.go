// Decodes citm_catalog.json (map-heavy, deeply nested objects) into Go's generic
...
// same input into interface{}. Pairs with the typed citm_catalog case to show the
