...
string — worth **−16% time and −53% allocations** on an escape-heavy document,
and −10%/−65% on a tweet corpus full of `\/` and `\uXXXX`. The chunk is never larger than 16 KiB and never larger than
